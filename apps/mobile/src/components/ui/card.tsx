...
function Card({ className, ...props }: React.ComponentProps<typeof View> & React.RefAttributes<View>) {
  // Existing screens render content straight into <Card> (no CardContent wrapper), so the
  // root keeps padding on all sides instead of RNR's default header/footer-only spacing.
  return (
